...
export const mutations = {
  update(state, payload) {
    state.activeItem.species = payload.species;
    state.activeItem.field_data.ANIMAL_IDENTIFYINGMARKERSTARTDATE =
      payload.field_data.ANIMAL_IDENTIFYINGMARKERSTARTDATE;
    state.activeItem.field_data.ANIMAL_ORIGINALMARKER =
      payload.field_data.ANIMAL_ORIGINALMARKER;
    if (typeof payload.field_data.ANIMAL_CURRENTMARKER != "undefined") {
      state.activeItem.field_data.ANIMAL_CURRENTMARKER =
        payload.field_data.ANIMAL_CURRENTMARKER;
    }
  },
  add(state, animal) {
